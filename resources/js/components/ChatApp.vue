...
<div class="container-messenger">        
    ...
    <div class="container-chat-center">
                  ...
                  <div class="chats" > 
                  <div class="msg-page">
                  <div class="received-chats" v-for="user  in users" :key="user.id" > 
                  ...
                  <div class="outgoing-chats" v-for="message  in messages" :key="message.id"  > 
                  <div class="outgoing-chats-msg"> 
                  <p>{{ message.content }} </p>
                  <span class="time">11:01 PM | October 11</span>
                  </div>
                  <div class="outgoing-chats-img">
                     <img :src="message.user.images">
                  </div>
                  </div>
                    </div>
                    </div>
  ...
  export default {
        ...
        data() {
         ...
         created() {
          ...
          methods: {
            fetchMessages() {
                axios.get('http://127.0.0.1:8000/api/getalluser').then(response => {
                    this.users = response.data;
                })
            },
             admin() {
                axios.get('http://127.0.0.1:8000/api/getAdmin').then(response => {
